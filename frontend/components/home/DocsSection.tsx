      ...
      <section id="documents" className={styles.documents}>
        <div className="row">
          <div className="col-md-6 col-sm-10 d-flex flex-column justify-content-start ps-5 pt-4">
           <Image src="/images/documents.png" height="450" width="400" alt="alguerocode vectro image for documents section"/>
          </div>
          <div className="col-md-6 col-sm-10 d-flex flex-column pt-5 ms-sm-4 ms-md-0 ms-4">
              ...
              <h1 className="mb-4">coming soon!</h1>
               ...
               <div className="d-flex justify-content-start align-items-center flex-row mt-5 ms-4">
                   <Link href="/docs">
